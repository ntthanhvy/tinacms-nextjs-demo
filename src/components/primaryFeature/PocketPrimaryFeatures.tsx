...
import {
	PageBlocksPrimaryFeature,
	PageBlocksPrimaryFeatureFeatures,
...
function DeviceUserIcon(props: SVGAttributes<SVGElement>) {
	return (
...
function DeviceNotificationIcon(props: SVGAttributes<SVGElement>) {
	return (
		<svg viewBox="0 0 32 32" aria-hidden="true" {...props}>
			<circle cx={16} cy={16} r={16} fill="#A3A3A3" fillOpacity={0.2} />
			<path
...
function DeviceTouchIcon(props: SVGAttributes<SVGElement>) {
	let id = useId();
...
function FeaturesDesktop({
	...
	features: PageBlocksPrimaryFeatureFeatures[];
}) {
				...
				{features.map((feature, featureIndex) => (
					...
					>
						...
						<div className="relative z-10 p-8">
							...
							{feature.icon && <DeviceTouchIcon className="h-8 w-8" />}
...
export function PocketPrimaryFeatures({
	data,
}: {
	...
	return (
		...
		>
			...
			<Container className="hidden md:mt-20 md:block">
				<FeaturesDesktop features={(data.features as any) ?? []} />
			</Container>
		</section>
	);
}
