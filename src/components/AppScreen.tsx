import { PropsWithChildren, Ref, SVGAttributes, forwardRef } from "react";
import clsx from "clsx";

function Logo(props: SVGAttributes<SVGSVGElement>) {
	return (
...
AppScreen.Body = forwardRef(function AppScreenBody(
	{ children, className }: PropsWithChildren<any>,
	ref: Ref<HTMLDivElement>
) {
	return (
		<div
