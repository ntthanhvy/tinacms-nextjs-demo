...
export function LaravelLogo(props: SVGAttributes<SVGElement>) {
	return (
...
export function TupleLogo(props: SVGAttributes<SVGElement>) {
	return (
		<svg viewBox="0 0 40 40" fill="#fff" aria-hidden="true" {...props}>
			<path
				fillRule="evenodd"
...
export function TransistorLogo(props: SVGAttributes<SVGElement>) {
	return (
		<svg viewBox="0 0 40 40" fill="#fff" aria-hidden="true" {...props}>
...
export function DiageoLogo(props: SVGAttributes<SVGElement>) {
	return (
		<svg
			viewBox="0 0 40 40"
			fill="#fff"
...
export function StaticKitLogo(props: SVGAttributes<SVGElement>) {
	return (
		<svg viewBox="0 0 40 40" fill="#fff" aria-hidden="true" {...props}>
...
export function StatamicLogo(props: SVGAttributes<SVGElement>) {
	return (
		<svg viewBox="0 0 40 40" fill="#fff" aria-hidden="true" {...props}>
			<path
				fillRule="evenodd"
...
export function MirageLogo(props: SVGAttributes<SVGElement>) {
	return (
		<svg viewBox="0 0 40 40" fill="#fff" aria-hidden="true" {...props}>
			<path
				fillRule="evenodd"
...
export function ReversableLogo(props: SVGAttributes<SVGElement>) {
	return (
		<svg
			viewBox="0 0 40 40"
			fill="none"
